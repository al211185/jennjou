export default function Hero() {
  return (
    <section
      id="inicio"
      className="relative isolate mx-auto flex min-h-screen w-full max-w-6xl items-center justify-center overflow-hidden border-y border-black px-8 py-24 text-center scroll-mt-32 snap-start"
    >
