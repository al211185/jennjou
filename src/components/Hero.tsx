export default function Hero() {
  return (
    <section
      id="inicio"
className="relative isolate mx-auto flex min-h-screen w-full max-w-6xl items-center justify-center overflow-hidden rounded-3xl border border-black bg-white px-8 py-24 text-center shadow-[0_35px_120px_-80px_rgba(0,0,0,0.55)] scroll-mt-32 snap-start"
    >
